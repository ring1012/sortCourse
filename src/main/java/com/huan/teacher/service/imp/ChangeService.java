...
public class ChangeService {
	...
	public void excute(String fixTable,String changeStr,startSortCourse myCourse,HttpServletRequest request) throws Myexception{
